...
factors.pca <- c('Accepted_Offer1', 'Accepted_Offer2', 'Accepted_Offer3', 'Accepted_Offer4', 'Accepted_Offer5', 'Response_Latest')
...
# As the new dataset has been created with the 4 components, I will now view the PCA values
